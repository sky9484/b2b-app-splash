...
const inputCls =
  "w-full rounded-lg border bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-offset-0 transition placeholder:text-slate-400";
      ...
      >
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.7)" }}>
            Splash lets Malaysian SMEs send PHP payouts straight from FPX. One flat 1.5% fee, real-time tracking,
            no crypto required.
          </p>
        ...
        <div
          className="absolute -right-32 -bottom-32 w-96 h-96 rounded-full"
          style={{ background: "radial-gradient(circle, rgba(34,167,240,0.18) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <div className="flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            title={!ZK_CONFIGURED ? "Add VITE_GOOGLE_CLIENT_ID to frontend/.env to enable" : ""}
          ...
          <form onSubmit={submit} className="space-y-4" data-testid="auth-form">
            ...
            {error && (
              <div
                className="text-sm rounded-lg px-3 py-2 bg-red-50 text-red-600 border border-red-100"
          ...
          {!ZK_CONFIGURED && (
            <div
              ...
              style={{ backgroundColor: "var(--processing-bg)", color: "var(--processing)", border: "1px solid var(--processing-border)" }}
            >
              <div className="font-semibold mb-1">Enable Google sign-in (zkLogin)</div>
              <ol className="list-decimal list-inside space-y-1 opacity-80">
                <li>Create an OAuth 2.0 Client ID at{" "}
                ...
                <li>Add to <code className="bg-blue-100 px-1 rounded">frontend/.env</code>:<br />
                  <code className="bg-blue-100 px-1 rounded">VITE_GOOGLE_CLIENT_ID=your-client-id</code>
                </li>
